...
def discover_methods() -> t.Tuple[t.Dict[str, TrainerConfig], t.Dict[str, str]]:
    ...
    methods = {}
    descriptions = {}
    return methods, descriptions # discover_methods func finds gof config which breaks nerfstudio - no idea where this config is so have it return nothing for now because there should be no new methods to incorporate
